...
import { UpdateUserDto, AddUserDto, SetPasswordParams, IdentityResultDto } from './user.dtos';
...
export class UserCrudService {
    constructor(
        ...
        private webApiService: UserWebApiService,
    ...
    public async createUser() {
        ...
        let dto: AddUserDto = await this.webApiService.getAddUser();
        try {
    ...
    private async onOkUpdateUserDialog(dto: UpdateUserDto) {
        try {
            let identityResultDto: IdentityResultDto = await this.webApiService.updateUser(dto);
            if (identityResultDto.Succeeded) {
