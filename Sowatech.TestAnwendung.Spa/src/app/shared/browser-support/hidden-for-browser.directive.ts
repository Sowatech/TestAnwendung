...
@Directive({ selector: '[hidden-for-browser]' })

export class HiddenForBrowserDirective implements OnInit, OnDestroy {

    @Input('hidden-for-browser') set _hiddenForBrowser(value: BrowserInput[]) {
        this.browsers = value;
    }
